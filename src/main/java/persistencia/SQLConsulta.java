...
public class SQLConsulta {
	...
	{
		Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaConsulta() + "(Num_Cc, Nombre, Correo_Electronico, Num_Registro, Especialidad, Id_Servicio_Asociado, Id_Adscritos) values (?, ?, ?, ?, ?, ?, ?)");
